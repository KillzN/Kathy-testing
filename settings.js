...
global.botNumberCode = '' //Ejemplo: +56955274723
global.confirmCode = ''

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.owner = [
  ['56955274723', 'KATHYBOT', true],
  ['56955274723', 'KATHYBOT', true],
  ['56955274723', 'KATHYBOT', true],
  ['56955274723'],
  ['56955274723'],
...
global.sessions = 'KATHYBOTSession'
global.jadi = 'KATHYBOTJadiBot'
...
global.estilo = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "56955274723-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount: -999999, status: 1, surface: 1, message: 'Ai Otho - MD', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net' } } }

...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *KATHYBOT*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *KATHYBOT*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *KATHYBOT*.`,
